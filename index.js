...
const validateInputs = () => {
  ...
  if (projectValue === "") {
    setError(project, "Project is required");
  } else {
    setSuccess(project);
  }

  if (messageValue === "") {
    setError(messageSend, "message is required");
  } else {
    setSuccess(messageSend);
  }
};
...
function SendMail() {
  ...
  if(username === "" || email === "" || project === "" || messageSend === ""){
    ...
    emailjs.send("service_csfh48k", "template_29tmujm", params).then(function (res) {
